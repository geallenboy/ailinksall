...
import { Filter, TrendingUp, LucideIcon, ChevronDown, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <Badge 
                  ...
                  className={cn(
                    ...
                    selectedCategory === 'all' && 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300'
                  )}
                >
                  {totalCount}
                </Badge>
        ...
        {/* 动态分类 - 支持收缩 */}
        {(collapsible ? isExpanded : true) && categories.map((category, index) => {
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {(category.description || category.descriptionZh) && (
                      <div className="text-xs text-muted-foreground mt-1 line-clamp-2 leading-tight">
                        {locale === 'zh' ? (category.descriptionZh || category.description) : category.description}
                      </div>
                    )}
                  </div>
                </div>
