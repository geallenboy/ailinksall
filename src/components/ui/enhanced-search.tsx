...
export function EnhancedSearch({ 
  ...
  return (
    <div className={cn("relative w-full", className)}>
      ...
      {/* 装饰性元素 */}
      <div className="absolute inset-0 bg-gradient-to-r from-blue-500/3 via-purple-500/3 to-indigo-500/3 rounded-3xl -z-10 group-focus-within:from-blue-500/8 group-focus-within:via-purple-500/8 group-focus-within:to-indigo-500/8 transition-all duration-300"></div>
    </div>
  );
} 